...
urlpatterns = [
    ...
    path('room/<str:room_name>/people/last10/', views_info.room_last_10_people,
    ...
    path('room/<str:room_name>/temperature/last10/', views_info.room_last_10_temperature,
         name='room-last-10-temperature'),
    path('room/<str:room_name>/temperature/add/', views_info.room_add_temperature,
    ...
    path('room/<str:room_name>/door/<str:door_id>/addTs/', views_puerta.DoorOpenView.as_view(),
         name='door-add-ts'),
    path('room/<str:room_name>/door/<str:door_id>/activity/', views_puerta.get_recent_door_activity,
         name='door-activity'),
    path('room/<str:room_name>/window/all/', views_ventana.get_all_windows, name='window-all'),
    path('room/<str:room_name>/window/create/', views_ventana.WindowView.as_view(),
         name='window-create'),
    path('room/<str:room_name>/window/<str:window_id>/',
         views_ventana.WindowView.as_view(), name='window'),
    path('room/<str:room_name>/window/<str:window_id>/addTs/',
         views_ventana.WindowOpenView.as_view(),
         name='window-add-ts'),
    path('room/<str:room_name>/window/<str:window_id>/activity/',
    ...
    path('room/<str:room_name>/light/<str:light_id>/addTs/', views_luz.LightIsOnView.as_view(),
         name='light-add-ts'),
    path('room/<str:room_name>/light/<str:light_id>/activity/', views_luz.get_recent_light_activity,
         name='light-activity'),
